...
android {
    namespace = "com.mikhaellopez.circularprogressbar"
    compileSdk = 34
    defaultConfig {
        minSdk = 14
    }
...
centralPortal {
    ...
    pom {
        ...
        url = "https://github.com/liyuhaolol/CircularProgressBar"
        licenses {
            license {
                name = "The MIT License"
                url = "https://github.com/liyuhaolol/CircularProgressBar/blob/master/LICENSE"
            }
        }
        developers {
            developer {
        ...
        scm {
            connection = "scm:git@github.com/liyuhaolol/CircularProgressBar.git"
            developerConnection = "scm:git@github.com/liyuhaolol/CircularProgressBar.git"
            url = "https://github.com/liyuhaolol/CircularProgressBar"
        }
